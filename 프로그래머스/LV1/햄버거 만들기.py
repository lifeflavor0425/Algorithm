# 햄버거 만들기
# 문제 설명
# 햄버거 가게에서 일을 하는 상수는 햄버거를 포장하는 일을 합니다. 함께 일을 하는 다른 직원들이
# 햄버거에 들어갈 재료를 조리해 주면 조리된 순서대로 상수의 앞에 아래서부터 위로 쌓이게 되고,
...
#         idx = ingredient.index(1)
#         print(idx)
#         if ingredient[idx : idx + 4] == [1, 2, 3, 1]:
#             ingredient = tmp + ingredient[idx+4:]
#             answer += 1
#             tmp.clear()
#         else:
#             tmp.append(ingredient.pop(0))
#     print(tmp, ingredient)
#     print(answer)
#     return answer
