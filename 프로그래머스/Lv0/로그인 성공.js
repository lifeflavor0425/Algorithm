...
function solution(id_pw, db) {
  const idCorrect = db.filter((array) => array[0] === id_pw[0]);
  if (idCorrect.length === 0) return print.fail;
  if (idCorrect[0][1] === id_pw[1]) return print.login;
  else return print.wrongPW;
}
